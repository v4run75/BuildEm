        ...
        loginTime!!.setOnClickListener {
            ...
            val timePickerDialog = TimePickerDialog(context,
                    TimePickerDialog.OnTimeSetListener { view, hourOfDay, minute ->
                        ...
                        loginTimeText = c.get(Calendar.YEAR).toString() + "-" + mMonth + "-" + mDay + " " + sHour + ":" + sMinute + ":" + "00"
                    }, mHour, mMinute, true)
        ...
        logoutTime!!.setOnClickListener {
            ...
            val timePickerDialog = TimePickerDialog(context,
                    TimePickerDialog.OnTimeSetListener { view, hourOfDay, minute ->
                        ...
                        logoutTimeText = c.get(Calendar.YEAR).toString() + "-" + mMonth + "-" + mDay + " " + sHour + ":" + sMinute + ":" + "00"
                    }, mHour, mMinute, true)
            timePickerDialog.show()
        }
            ...
            builder!!.setMessage("Do you want to Submit?")
                    ...
                    .setPositiveButton("Yes") { dialog, id ->
                        if (validate(loginTime!!.text.toString(), logoutTime!!.text.toString(), description!!.text.toString())) {
                            ...
                            try {
                                sendRequest(selectedItem!!.asset_id, selectedItem!!.inventory_item_rent_id, loginTimeText, logoutTimeText, service_time!!.text.toString(), description!!.text.toString())
