...
class ViewCustomerData : AppCompatActivity() {
    ...
    private var listener = CustomerDataAdapter.OnItemClickListener { item, pos, view ->
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listAdapter = CustomerDataAdapter(context, ArrayList<CustomerData.Details>(), listener)
    ...
    private fun getCustomerData() {
        ...
        requestUrl = requestUrl.replace("[2]", type!!)
        ...
        app!!.sendNetworkRequest(requestUrl, Request.Method.POST, null, object : Interfaces.NetworkInterfaceListener {
            ...
            override fun onNetworkRequestComplete(response: String) {
                ...
                try {
                    ...
                    listAdapter = CustomerDataAdapter(context!!, itemList!!.details, listener)
                    items!!.adapter = listAdapter
