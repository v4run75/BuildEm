...
class AddComplaintAdapter(private val context: Context, users: ArrayList<ComplaintDetails.Details>, private val listener: OnItemClickListener) : RecyclerView.Adapter<AddComplaintAdapter.ViewHolder>() {
    ...
    interface OnItemClickListener {
        ...
        fun onItemCheck(serviceItem: ComplaintDetails.Details, pos: Int, view: View, qty: TextView, checked: Boolean, check: CheckBox)
    }
