...
class AddInstallationAdapter(private val context: Context, users: ArrayList<WorkListItem>, private val listener: OnItemClickListener) : RecyclerView.Adapter<AddInstallationAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddInstallationAdapter.ViewHolder {
